        ...
        <tr>
          ...
          <td class="align-middle">
            <form action="delete_record.php" method="post" id="delete_record_form">
              <input class"indexInput" type="hidden" name="record_id" value="<?php echo $record['recordID']; ?>">
              <input class"indexInput" type="hidden" name="category_id" value="<?php echo $record['categoryID']; ?>">
              <input  class"indexInput"  type="submit" value="Delete">
            </form>
          </td>
          <td class="align-middle">
            <form action="edit_record_form.php" method="post" id="delete_record_form">
              <input class"indexInput" type="hidden" name="record_id" value="<?php echo $record['recordID']; ?>">
              <input class"indexInput" type="hidden" name="category_id" value="<?php echo $record['categoryID']; ?>">
              <input  class"indexInput"  type="submit" value="Edit">
            </form>
          </td>
        </tr>
