...
<div class="container">
    ...
    <form action="add_record.php" method="post" enctype="multipart/form-data"
     id="add_record_form">
        ...
        <select class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp1"  name="category_id">
        ...
        <input class="form-control" id="exampleInputEmail2" aria-describedby="emailHelp1" type="input" name="name" required>
